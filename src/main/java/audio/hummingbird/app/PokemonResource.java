...
/**
 * This class implements REST endpoints to interact with Pokemons. The following operations are
 * supported:
 *
 * <ul>
 *   <li>GET /pokemon: Retrieve list of all pokemons
 *   <li>GET /pokemon/{id}: Retrieve single pokemon by ID
 *   <li>GET /pokemon/name/{name}: Retrieve single pokemon by name
 *   <li>DELETE /pokemon/{id}: Delete a pokemon by ID
 *   <li>POST /pokemon: Create a new pokemon
 * </ul>
 *
    ...
    try {
      PokemonType pokemonType =
          entityManager
              ...
              .setParameter("id", pokemon.getType())
              .getSingleResult();
